...
const receiptTypeValues = Object.keys(RECEIPT_TYPES) as [ReceiptType, ...ReceiptType[]];
const receiptStatusValues = Object.keys(RECEIPT_STATUS) as [ReceiptStatus, ...ReceiptStatus[]];
...
export const CreateGoodsReceiptSchema = z.object({
  ...
  delivererName: z.string().min(1, "Họ tên người giao hàng không được để trống"),
  ...
  items: z.array(ReceiptItemInputSchema).min(1, "Phiếu nhập phải có ít nhất 1 dòng vật tư"),
});
...
export type GoodsReceiptListItem = Omit<GoodsReceipt, "items">;
